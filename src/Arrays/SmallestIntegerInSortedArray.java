...
/**
 * Created by vkittala on 6/7/2018.
 * This programm is to find the smallest number that cannot be represented by any subset of an array
 */
public class SmallestIntegerInSortedArray {
    ...
    public static void main(String arg[]){
        ...
        int [] arrA = {1,2,6,7,9};
        System.out.println("{2,4,1,6,3,7} " + i.find(arrA));
       /* int [] arrB = {1,1,1,1,1};
